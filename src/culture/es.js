(function (translator) {
	translator.translations["es"] = {
		...
		"tagline": "Generador de billeteras Bitcoin de código abierto en lado de cliente con Javascript",
		...
		"bulklabela2li2": "Importa las direcciones en la base de datos de tu servidor. No subas la billetera ni las claves públicas, o de lo contrario te lo pueden robar. Sube sólo las direcciones, ya que es lo que se va a mostrar a los clientes.",
		...
		"bulklabela2li5": "Las bitcoins que recibas se almacenarán de forma segura en la cadena de bloques. Usa la billetera original que generaste en el paso 1 para usarlas.",
		...
		"detaillabelnote2": "Bitcoin v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una billetera antigua o nueva.",
